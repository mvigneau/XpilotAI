...
def AI_loop():
  ...
  start = (Distance_CloseTopAlertValue + (((Distance_CloseTopAlertValue - Distance_FarTopAlertValue)/2)+1))
  ...
  Distance_FarBottomAlertValue = transform_fuzzy(Distance_FarBottomAlert, 50, start, end)
