...
def AI_loop():
  ...
  closingRate_SlowBottomAlertValue = transform_fuzzy(closingRate_SlowBottomAlert, 1, closingRate_SlowTopAlertValue, closingRate_SlowTopAlertValue+16)   
  ...
  closingRate_MediumBottomLeftAlertValue = transform_fuzzy(closingRate_MediumBottomLeftAlert, 1, closingRate_MediumTopLeftAlertValue-16, closingRate_MediumTopLeftAlertValue) 
  ...
  closingRate_FastBottomAlertValue = transform_fuzzy(closingRate_FastBottomAlert, 1, closingRate_FastTopAlertValue-16, closingRate_FastTopAlertValue) 
  ...
  Distance_CloseBottomAlertValue = transform_fuzzy(Distance_CloseBottomAlert, 50, Distance_CloseTopAlertValue, Distance_CloseTopAlertValue+(50*(2**len(Distance_CloseBottomAlert)))) 
  print("Distance_CloseBottomAlertValue", Distance_CloseBottomAlertValue)
  Distance_FarBottomAlert = current_chromosome[47:52]
  Distance_FarBottomAlertValue = transform_fuzzy(Distance_FarBottomAlert, 50, Distance_FarTopAlertValue-(50*(2**len(Distance_FarBottomAlert))), Distance_FarTopAlertValue) 
